...
2. Navigate to the "microbit-arcade-main" folder. Instructions for this will vary based on your file structure, but most likely: `cd Downloads/microbit-arcade-main`
